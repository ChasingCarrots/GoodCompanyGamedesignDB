...
urlpatterns = [
    ...
    url(r'^goodcompany/helper/getbalancingtablejson/(?P<tablename>\w+)/(?P<limitFrom>\d+)/(?P<limitTo>\d+)/(?P<displayMode>\d+)/(?P<logisticTime>\d+)', getBalancingTableJson, name="getbalancingtablejson"),
